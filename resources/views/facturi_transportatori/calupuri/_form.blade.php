...
<div class="row">
    ...
    <div class="col-lg-3 mb-3">
        <label for="data_plata" class="mb-0 ps-2">Data plata</label>
        <input
            type="date"
            name="data_plata"
            id="data_plata"
...
<div class="mb-3">
    <label for="observatii" class="mb-0 ps-2">Observatii</label>
    <textarea
        name="observatii"
        id="observatii"
...
<div class="mb-3">
    <label for="fisiere_pdf" class="mb-0 ps-2">Fisiere PDF</label>
    <input
        type="file"
        name="fisiere_pdf[]"
        id="fisiere_pdf"
        ...
        multiple
    >
    <small class="form-text text-muted">Poti selecta unul sau mai multe fisiere PDF.</small>
