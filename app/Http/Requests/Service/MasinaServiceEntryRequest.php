...
abstract class MasinaServiceEntryRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            if ($tip === 'piesa') {
                ...
                $available = $this->availableStock($this->piesa);
                if ($cantitate > $available) {
    ...
    protected function availableStock(GestiunePiesa $piesa): float
    {
        return (float) $piesa->nr_bucati + $this->additionalPieceStock($piesa);
    }
